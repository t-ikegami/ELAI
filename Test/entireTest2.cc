...
int main( int argc, char **argv )
{
  ...
  if ( rk == 0 )
  {
    ...
    s.join( Element( 6, PSI, rid ), Element( 2, PSI, 2 ) );
    s.join( Element( 7, PSI, rid ), Element( 3, PSI, 2 ) );
    ...
    Family t( s );
    t.join( l0 ).join( l1 ).join( l2 ).join( l3 ).join( l4 ).join( l5 ).join( l6 ).join( l7 );
  ...
  else if ( rk == 1 )
  {
    ...
    s.join( Element( 6, PSI, rid ), Element( 3, PSI, 3 ) );
  ...
  else if ( rk == 2 )
  {
    ...
    s.join( Element( 2, PSI, rid ) );
    s.join( Element( 3, PSI, rid ) );
    s.join( Element( 4, PSI, rid ), Element( 3, PSI, 3 ) );
    s.join( Element( 5, PSI, rid ) );
    s.join( Element( 6, PSI, rid ) );
    s.join( Element( 7, PSI, rid ), Element( 6, PSI, 3 ) );
  ...
  else if ( rk == 3 )
  {
    ...
    Space s;
    s.join( Element( 0, PSI, rid ), Element( 4, PSI, 1 ) );
    s.join( Element( 1, PSI, rid ), Element( 5, PSI, 1 ) );
    s.join( Element( 2, PSI, rid ), Element( 3, PSI, 2 ) );
    s.join( Element( 3, PSI, rid ) );
    s.join( Element( 4, PSI, rid ) );
    s.join( Element( 5, PSI, rid ), Element( 6, PSI, 2 ) );
    s.join( Element( 6, PSI, rid ) );
